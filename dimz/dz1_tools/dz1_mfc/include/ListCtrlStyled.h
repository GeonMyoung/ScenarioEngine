// "CListCtrlStyled" by ANDRE S?astien @2002 (maximus@oreka.com) (http://divxdede.fr.st)
//
...
typedef struct CListCtrlStyledColumnDesign
{
	LPTSTR name;
	int fmt;							// LVCFMT_LEFT, LVCFMT_CENTER, LVCFMT_RIGHT
	int cx;
} CListCtrlStyledColumnDesign;

#define CLIST_COLUMN_WITH(letter, fs)		((letter * fs) + 4)
// --------------------------
