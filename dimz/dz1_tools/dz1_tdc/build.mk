...
LDLIB_DZ1		= -ldz1util -ldz1parser -ldz1kernel -ldz1struct
...
CINC_GLOBAL		+= -I$(TDIINC)
LDPATH_GLOBAL	+= -L$(TDILIB)
LDLIB_TDI		= -ldz1tdcinfo
...
CNVLIB			= $(CNVDIR)/lib/$(TARGET_TYPE)lib

CINC_GLOBAL		+= -I$(CNVINC)
LDPATH_GLOBAL	+= -L$(CNVLIB)
LDLIB_CNV		= -lcodeconv
...
LDLIB_GLOBAL	+= $(LDLIB_TDI)
LDLIB_GLOBAL	+= $(LDLIB_DZ1)
LDLIB_GLOBAL	+= $(LDLIB_CNV)
