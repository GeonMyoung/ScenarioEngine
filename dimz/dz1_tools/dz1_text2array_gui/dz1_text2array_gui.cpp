// dz1_text2array_gui.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CText2ArrayApp, CWinApp)
...
// 유일한 CText2ArrayApp 개체입니다.

CText2ArrayApp theApp;


// CText2ArrayApp 초기화

BOOL CText2ArrayApp::InitInstance()
{
...
bool_t MyGetPath(HWND owner, TCHAR *initialPAth, TCHAR path[MAX_PATH], TCHAR *title)
{
	bool_t ret = FALSE;
