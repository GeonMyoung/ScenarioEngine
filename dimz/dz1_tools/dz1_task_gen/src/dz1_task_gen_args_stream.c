...
ssize_t GenArgs2VisualStudioEntry_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
...
ssize_t GenArgs2VisualStudioList_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
	DZ1_ERROR_SAFE_PTR(errp, err);
...
ssize_t GenArgs2LibraryEntry_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
	DZ1_ERROR_SAFE_PTR(errp, err);
...
ssize_t GenArgs2LibraryList_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
	DZ1_ERROR_SAFE_PTR(errp, err);
...
ssize_t GenArgs2LibraryInfo_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
	DZ1_ERROR_SAFE_PTR(errp, err);
...
ssize_t GenArgs2VisualStudio_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
	DZ1_ERROR_SAFE_PTR(errp, err);
	...
	{
		DZ1_IO_STREAM_FUNC(ret, Dz1StrUTF8_read(&dst->pthread_root, src, ed, param, errp), errp);
...
ssize_t GenArgs2VisualStudio_write(Dz1Stream *dst, void *_src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	...
	{
		DZ1_IO_STREAM_FUNC(ret, Dz1StrUTF8_write(dst, src->pthread_root, ed, param, errp), errp);
		DZ1_STREAM_WRITE4(dst, src->gen_project, ed, errp, ret);
	}
	return ret;
}

ssize_t GenArgs2_read(void *_dst, Dz1Stream *src, Dz1IOStreamEndian ed, void *param, Dz1Error *err)
{
	ssize_t ret = 0;
	DZ1_ERROR_SAFE_PTR(errp, err);
