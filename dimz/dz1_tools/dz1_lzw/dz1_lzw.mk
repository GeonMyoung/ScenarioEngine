...
CCVLDF			+= -L$(CCVDIR)/lib/$(TARGET_TYPE)lib -lcodeconv
...
CFLAGS		+= -I$(INCDIR) $(EXT_CFLAGS) -I$(DZ1INC) -I$(CCVINC)

###############################################################################
###     LDFLAGS Setting                                                     ###
###############################################################################
LDFLAGS		 = -L$(LIBDIR) $(EXT_LDFLAGS) -L$(DZ1LIB) $(SUB_LDFLAGS) \
				$(EXT_LIBS) \
