================================================================================
              MFC 라이브러리 : dz1_task_gen_gui 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 dz1_task_gen_gui 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 dz1_task_gen_gui 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.

dz1_task_gen_gui.vcproj
...
dz1_task_gen_gui.h
    ...
    특정 헤더가 포함되며 CDz1TaskGen_app 응용 프로그램 클래스가 선언됩니다.

dz1_task_gen_gui.cpp
    CDz1TaskGen_app 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\dz1_task_gen_gui.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.
    이 아이콘은 주 리소스 파일인 dz1_task_gen_gui.rc에 포함됩니다.

res\dz1_task_gen_gui.rc2
...
dz1_task_gen_dlg.h, dz1_task_gen_dlg.cpp - 대화 상자
    CDz1TaskGen_dlg 클래스를 포함하는 파일입니다.  이 클래스에는 응용 프로그램의
    주 대화 상자에 대한 동작이 정의됩니다. 대화 상자의 템플릿은 dz1_task_gen_gui.rc에
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) dz1_task_gen_gui.pch 및 미리 컴파일된
