#ifndef _ASN_BER_VideotexSTRING_H_
#define _ASN_BER_VideotexSTRING_H_
...
/************************************************
function_name:ASN1_BER_Enc_VideotexString                              
input:
...
ASN1_CPPLINK ASNINT32 ASN1_BER_Enc_VideotexString(ASN1WorkSpace* ws,VideotexString* value,
							 ASN1TagType flag);

/************************************************
function_name:ASN1_BER_Dec_VideotexString                              
input:
      ASN1WorkSpace* ws: data save and work space
...
ASN1_CPPLINK ASNINT32 ASN1_BER_Dec_VideotexString(ASN1WorkSpace* ws,VideotexString* value,
							 ASNINT32 length,ASN1TagType flag);

#endif /*_ASN_VideotexSTRING_H_*/
