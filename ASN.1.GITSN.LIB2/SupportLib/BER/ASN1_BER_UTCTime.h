#ifndef _ASN_BER_UTCTime_H_
#define _ASN_BER_UTCTime_H_
...
/************************************************
function_name:ASN1_BER_Enc_UTCTime                              
input:
...
/************************************************
function_name:ASN1_BER_Dec_UTCTime                              
input:
      ASN1WorkSpace* ws: data save and work space
...
ASN1_CPPLINK ASNINT32 ASN1_BER_Dec_UTCTime(ASN1WorkSpace* ws,UTCTime* value,
							 ASNINT32 length,ASN1TagType flag);


#endif /*_ASN_UTCTime_H_*/
