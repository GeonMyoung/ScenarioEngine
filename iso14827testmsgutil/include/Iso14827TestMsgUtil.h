#ifndef ISO14827_TEST_MSG_UTIL_H
#define ISO14827_TEST_MSG_UTIL_H
...
typedef struct Iso14827TestMsgStructAPI
{
	...
	bool_t(*init_sample_data)(void* pptr, Dz1Error* err);
	bool_t(*init_sample_data_by_psid)(void* pptr, u32_t psid, Dz1Error* err);
	bool_t(*init_sample_data_by_psid_and_payload_type)(void* pptr, u32_t psid, u32_t payloadType, Dz1Error* err);
	// Dz1Binary* (*getPublicationData)(Dz1Str oidStr, Dz1Error *err);
}Iso14827TestMsgStructAPI;
...
#define Iso14827TestMsgUtil_GetTime(year, mon, day, hour, min) GetTimeT(year, mon, day, hour, min)
...
#define Iso14827TestMsgUtilAPIEntry(oid_str, eam_list_struct, struct_name)\
		{\
			...
			eam_list_struct##_init_sample_data,\
			eam_list_struct##_init_sample_data_by_psid,\
			eam_list_struct##_init_sample_data_by_psid_and_payload_type\
		}\
			// eam_list_struct##_getPublicationData
...
DZ1_CPPLINK Dz1Binary* Iso14827TestMsgSet_getPublicationSampleData(Iso14827TestMsgStructAPI* tbl, Dz1Str oidStr, Dz1Asn1Codec codec, Dz1Error* err);
DZ1_CPPLINK Dz1Binary* Iso14827TestMsgSet_getPublicationSampleDataByPsid(Iso14827TestMsgStructAPI* tbl, Dz1Str oidStr, u32_t psid, Dz1Asn1Codec codec, Dz1Error* err);
DZ1_CPPLINK Dz1Binary* Iso14827TestMsgSet_getPublicationSampleDataByPsidAndPayloadType(Iso14827TestMsgStructAPI* tbl, Dz1Str oidStr, u32_t psid, u32_t payloadType, Dz1Asn1Codec codec, Dz1Error* err);
DZ1_CPPLINK	Dz1Binary* Iso14827TestMsgSet_getNullData(Dz1Asn1Codec codec, Dz1Error* err);
DZ1_CPPLINK	Dz1Binary* Iso14827TestMsgSet_getEmptyList(Dz1Asn1Codec codec, Dz1Error* err);


#endif // ISO14827_TEST_MSG_UTIL_H
