...
static bool_t Itsk00126v1TestConfiguration_serverRole_setChild(void *ptr, Dz1JsonVarBind *info, Dz1Error *err)
{
	DZ1_ERROR_SAFE_PTR(errp, err);
	...
	case 1: Dz1Str_delAndSetNull(&p->local_center_id); p->local_center_id = (Dz1Str)info->data; info->data = NULL; break; // type_scalar = 0, ptr_instance = 0
...
static void *Itsk00126v1TestConfiguration_serverRole_getChild(void *ptr, Dz1JsonSpecChild **info, Dz1JsonSpecChilds *lists)
{
	Itsk00126v1TestConfiguration_serverRole *p = (Itsk00126v1TestConfiguration_serverRole *)ptr;
	Dz1JsonSpecChild *id = *(Dz1JsonSpecChild **)info;
	switch(id->index)
	...
	case 1: return p->local_center_id;
...
static Dz1JsonSpecChild Itsk00126v1TestConfiguration_serverRole_membs[] =
{
	{ Dz1Text("local_port"), Dz1Text("s64_t"), 0 },
	{ Dz1Text("local_center_id"), Dz1Text("Dz1Str"), 1 },
...
static bool_t Itsk00126v1TestConfiguration_clientRole_setChild(void *ptr, Dz1JsonVarBind *info, Dz1Error *err)
{
	DZ1_ERROR_SAFE_PTR(errp, err);
...
static void *Itsk00126v1TestConfiguration_clientRole_getChild(void *ptr, Dz1JsonSpecChild **info, Dz1JsonSpecChilds *lists)
{
	Itsk00126v1TestConfiguration_clientRole *p = (Itsk00126v1TestConfiguration_clientRole *)ptr;
	Dz1JsonSpecChild *id = *(Dz1JsonSpecChild **)info;
	switch(id->index)
...
static Dz1JsonSpecChild Itsk00126v1TestConfiguration_clientRole_membs[] =
{
...
static bool_t Itsk00126v1TestConfiguration_setChild(void *ptr, Dz1JsonVarBind *info, Dz1Error *err)
{
	DZ1_ERROR_SAFE_PTR(errp, err);
	...
	switch(id->index)
	{
	case Itsk00126v1TestConfigurationPresent_serverRole: Itsk00126v1TestConfiguration_serverRole_delAndSetNull(&p->x.serverRole); p->x.serverRole =(Itsk00126v1TestConfiguration_serverRole *)info->data; info->data = NULL; break;
	case Itsk00126v1TestConfigurationPresent_clientRole: Itsk00126v1TestConfiguration_clientRole_delAndSetNull(&p->x.clientRole); p->x.clientRole =(Itsk00126v1TestConfiguration_clientRole *)info->data; info->data = NULL; break;
	default: ERR_SET_OUT_RET(errp, ENOENT, FALSE);
	}
	p->present = (Itsk00126v1TestConfigurationPresent)id->index;
	return errp->code == 0 ? TRUE : FALSE;
}

static void *Itsk00126v1TestConfiguration_getChild(void *ptr, Dz1JsonSpecChild **info, Dz1JsonSpecChilds *lists)
{
	Itsk00126v1TestConfiguration *p = (Itsk00126v1TestConfiguration *)ptr;
	Dz1JsonSpecChild *id = (*info) = Dz1JsonSpecChilds_findByIdx(lists, p->present);
	if (id != NULL)
	{
		switch(p->present)
		{
		case Itsk00126v1TestConfigurationPresent_serverRole: return p->x.serverRole;
		case Itsk00126v1TestConfigurationPresent_clientRole: return p->x.clientRole;
		default: return NULL;
		}
	}
	else return NULL;
...
static Dz1JsonSpecChild Itsk00126v1TestConfiguration_membs[] =
{
	{ Dz1Text("serverRole"), Dz1Text("Itsk00126v1TestConfiguration_serverRole"), Itsk00126v1TestConfigurationPresent_serverRole },
	{ Dz1Text("clientRole"), Dz1Text("Itsk00126v1TestConfiguration_clientRole"), Itsk00126v1TestConfigurationPresent_clientRole },
	{ NULL, NULL, -1 }
};
// Itsk00126v1TestConfiguration
////////////////////////////////////////////////////////////////////////////////
...
bool_t Itsk00126v1TestScenarioDef_initJsonSpec(Dz1JsonSpec *dst, Dz1Error *err)
{
	DZ1_ERROR_SAFE_PTR(errp, err);
	...
	else
	{
		...
		else if ((*errp = Dz1JSonSpec_add_construct(dst, Dz1Text("Itsk00126v1TestConfiguration_serverRole"), Itsk00126v1TestConfiguration_serverRole_gen, Itsk00126v1TestConfiguration_serverRole_del, Itsk00126v1TestConfiguration_serverRole_setChild, Itsk00126v1TestConfiguration_serverRole_getChild, Itsk00126v1TestConfiguration_serverRole_membs, Dz1JsonConstructType_struct)).code) ERR_OUT(errp);
		else if ((*errp = Dz1JSonSpec_add_construct(dst, Dz1Text("Itsk00126v1TestConfiguration_clientRole"), Itsk00126v1TestConfiguration_clientRole_gen, Itsk00126v1TestConfiguration_clientRole_del, Itsk00126v1TestConfiguration_clientRole_setChild, Itsk00126v1TestConfiguration_clientRole_getChild, Itsk00126v1TestConfiguration_clientRole_membs, Dz1JsonConstructType_struct)).code) ERR_OUT(errp);
		else if ((*errp = Dz1JSonSpec_add_construct(dst, Dz1Text("Itsk00126v1TestConfiguration"), Itsk00126v1TestConfiguration_gen, Itsk00126v1TestConfiguration_del, Itsk00126v1TestConfiguration_setChild, Itsk00126v1TestConfiguration_getChild, Itsk00126v1TestConfiguration_membs, Dz1JsonConstructType_union)).code) ERR_OUT(errp);
...
Dz1JsonSpec *Itsk00126v1TestScenarioDef_genJsonSpec(Dz1Error *err)
{
	DZ1_ERROR_SAFE_PTR(errp, err);
	...
	else
	{
		...
		if (Itsk00126v1TestScenarioDef_initJsonSpec(ret, errp) == FALSE) ERR_OUT(errp);
