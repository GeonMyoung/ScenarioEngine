...
이 문서는 최초 구축 당시의 기록이다. 이후 GM-87에서 일반 작업과 명시적 업무 연동의 적용 조건을 분리했다. 현재 적용 기준은 [개발 절차](../development-workflow.md)와 [업무 연동 스킬](../../skills/scenarioengine-workflow/SKILL.md)을 따른다. 아래 구축·검증 이력은 그대로 보존한다.
